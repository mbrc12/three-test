...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28302 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28302(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28305 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28305(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28307 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28307(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28312 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28312(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28322 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28322(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28327 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28327(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28330 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28330(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28336 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28336(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28343 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28343(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28352 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28352(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28355 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28355(b);
}
});
